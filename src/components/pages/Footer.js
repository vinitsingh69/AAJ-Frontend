...
const Footer = () => {
    return (
        <div>
            {/* <!-- Header Section --> */}
            <header class="container mx-auto px-4 py-6 flex justify-between items-center border-b">
                <div class="flex items-center">
                    <img src={aaj_swift_logo} alt="AAJ Swift" class="h-8" />
                    <p class="ml-10 text-gray-600 text-sm">
                        Optimizing supply chains through<br />
                        warehousing and transportation services
                    </p>
                </div>
                <div class="flex gap-4">
                    <a href="#" class="w-10 h-10 rounded-full border flex items-center justify-center">
            ...
            {/* <!-- Footer Navigation --> */}
            <footer class="container mx-auto px-4 py-12">
                <div class="grid grid-cols-1 md:grid-cols-5 gap-8">
                    {/* <!-- Company Section --> */}
                    <div>
                        <h3 class="font-semibold text-gray-800 mb-4">Company</h3>
                        <ul class="space-y-2">
                            <li><a href="#" class="text-gray-600 hover:text-gray-800">Our Story</a></li>
                            <li><a href="#" class="text-gray-600 hover:text-gray-800">Careers at AAJ</a></li>
                    ...
                    <div>
                        ...
                        <ul class="space-y-2">
                            <li><a href="#" class="text-gray-600 hover:text-gray-800">E Commerce Fulfillment</a></li>
                            <li><a href="#" class="text-gray-600 hover:text-gray-800">Transport-AAJ Swift</a></li>
                            <li><a href="#" class="text-gray-600 hover:text-gray-800">Returns Management</a></li>
                            <li><a href="#" class="text-gray-600 hover:text-gray-800">Value Added Services</a></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul class="space-y-2">
                            <li><a href="#" class="text-gray-600 hover:text-gray-800">Track Your Order</a></li>
                        </ul>
                    </div>

                    {/* <!-- Transportation Network Section --> */}
                    <div>
                        <h3 class="font-semibold text-gray-800 mb-4">Transportation Network</h3>
                        <ul class="space-y-2">
                            <li><a href="#" class="text-gray-600 hover:text-gray-800">Transportation in Mumbai</a></li>
                            <li><a href="#" class="text-gray-600 hover:text-gray-800">Transportation in Bangalore</a></li>
                            <li><a href="#" class="text-gray-600 hover:text-gray-800">Transportation in Delhi</a></li>
                            <li><a href="#" class="text-gray-600 hover:text-gray-800">Transportation in Hyderabad</a></li>
                            <li><a href="#" class="text-gray-600 hover:text-gray-800">Transportation in Ghaziabad</a></li>
                            <li><a href="#" class="text-gray-600 hover:text-gray-800">Transportation in Sonipat NCR</a></li>
                        </ul>
                    </div>
                </div>

                {/* <!-- Footer Bottom --> */}
                <div class="mt-12 pt-8 border-t flex flex-col md:flex-row justify-between items-center text-sm text-gray-600">
                    <p>©2024 AAJ Swift. All Rights Reserved</p>
                    <p class="mt-4 md:mt-0">ISO 9001: 2015, ISO 27001: 2013 Certified Company CIN: L63090DL2011PLC221234</p>
                </div>
            </footer>
        </div>
    )
